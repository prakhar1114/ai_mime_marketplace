...
description: 'Place a Swiggy delivery order end-to-end: **search restaurant → pick
  the right restaurant (Gemini) → open menu → search dish → pick the right dish (Gemini)
